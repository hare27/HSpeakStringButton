...
- (instancetype)init
{
    ...
    if (self) {
        // 设置UI
        NSString *path = [[NSBundle mainBundle] pathForResource:@"play@2x" ofType:@"png" inDirectory:@"HSpeakStringResource.bundle"];
        UIImage *image = [UIImage imageWithContentsOfFile:path];
        [self setImage:image forState:UIControlStateNormal];
        path = [[NSBundle mainBundle] pathForResource:@"pause@2x" ofType:@"png" inDirectory:@"HSpeakStringResource.bundle"];
